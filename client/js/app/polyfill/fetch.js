...
System.register([], function (_export, _context) {
  ...
  var support, viewClasses, isArrayBufferView, methods, redirectStatuses, DOMException;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('DOMException', DOMException = self.DOMException);

      _export('DOMException', DOMException);

      try {
        new DOMException();
      } catch (err) {
        _export('DOMException', DOMException = function DOMException(message, name) {
